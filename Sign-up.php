...
<?php include "common/header.php"?>
        ...
        <main class="site-main post-837 page type-page status-publish hentry" role="main" style="margin: 0 0 5rem 0;">
                <div class="page-content">
                    ...
                    <nav class="woocommerce-breadcrumb"><a href="index.php">Home</a>&nbsp;&#47;&nbsp;Sign-Up</nav>		</div>
                        </div>
                    ...
                    <img src="wp-content/uploads/2021/07/nuts-walnuts-white-background (1).jpg" class="attachment-full size-full" alt="" loading="lazy" />
                ...
                <h3 class="elementor-image-box-title">Phone</h3><p class="elementor-image-box-description">
                    0-589-96369-95823
                     0-825-63596-471254</p></div>
                    </div>	 -->
                	</div>
                        </div>
                    ...
                    <div class="elementor-widget-wrap elementor-element-populated">
                        ...
                        <div class="elementor-widget-container">
                    <h2 class="elementor-heading-title elementor-size-default">Sign-Up Details</h2>		</div>
                        </div>
                    ...
                    <div class="elementor-field-type-text elementor-field-group elementor-column elementor-field-group-name elementor-col-50">
                            <label for="form-field-name" class="elementor-field-label elementor-screen-only">Password</label>
                        <input size="1" type="text" name="form_fields[name]" id="form-field-name" class="elementor-field elementor-size-lg  elementor-field-textual" placeholder="Password">		
                            </div>

                            <div class="elementor-field-type-text elementor-field-group elementor-column elementor-field-group-name elementor-col-50">
                            <label for="form-field-name" class="elementor-field-label elementor-screen-only">Confirm Password</label>
                        <input size="1" type="text" name="form_fields[name]" id="form-field-name" class="elementor-field elementor-size-lg  elementor-field-textual" placeholder="Last Name">		
                            </div>
